    ...
    var customer_id=document.getElementById("customer_id").value.trim();
  	if(from_date == "")
  	 ...
  	 if(to_date == "")
        ...
        $.post("accaunt_pay_rec_booking_report",{customer_id:customer_id,view_all:view_all,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
             $("#tbodybooking").empty().append(result);     
             $(".overlay").remove();
            }, 0);
           }); 
