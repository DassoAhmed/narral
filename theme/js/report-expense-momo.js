$("#view, #view_all").click(function(){
  ...
  // var momo=document.getElementById("momo").value.trim();
	 ...
	 if(to_date == "")
      {
	   ...
	   if(this.id=="view_all"){
        ...
        $.post("show_item_momo_expense_report",{category_id:category_id,payment_type:payment_type,view_all:view_all,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
