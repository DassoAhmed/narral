...
function customer_profile(customer_id){

  $.post($("#base_url").val().trim()+'customers/show_customer_profile_modal', {customer_id: customer_id}, function(result) {
    $(".customer_profile_modal").html('').html(result);
    //Date picker
    $('.datepicker').datepicker({
      autoclose: true,
    format: 'dd-mm-yyyy',
