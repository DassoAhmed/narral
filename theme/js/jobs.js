...
$('#save,#update').click(function (e) {
    ...
    if(this_id=="save")  //Save start
    {
					...
					if(confirm("Do You Wants to Save Record ?")){
						e.preventDefault();
						data = new FormData($('#jobs-form')[0]);//form name
						/*Check XSS Code*/
	...
	else  if(this_id=="save_activity")  //Save Activity Expense start
    {
	...
	else if(this_id=="update")  //Update start
    {
					...
					if(confirm("Do You Wants to Save Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'manufacturing/update_manufacturing',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
