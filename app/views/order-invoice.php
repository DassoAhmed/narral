  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $base_url; ?>orders/place_order"><?= $this->lang->line('new_order'); ?></a></li>
    ...
    $q3=$this->db->query("SELECT a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.order_code,b.order_status,b.purchase_note,
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> <?= $this->lang->line('order_invoice'); ?>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <b><?= $this->lang->line('oder_status'); ?> :<?php echo  $purchase_status; ?></b><br>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped records_table table-bordered">
            ...
            <tbody>
              ...
              $tot_total_cost=0;
              $q2=$this->db->query("SELECT c.item_name, a.order_qty,a.tax_type,
                                  a.price_per_unit, b.tax,b.tax_name,a.tax_amt,
                                  a.unit_discount_per,a.discount_amt, a.unit_total_cost,
                                  a.total_cost 
                                  FROM 
                                  db_booking_orderitems AS a,db_tax AS b,db_items AS c 
                                  WHERE 
                                  c.id=a.item_id AND b.id=a.tax_id AND a.order_id='$purchase_id'");
                       ...
                       <tbody>
                          <?php 
                            if(isset($purchase_id)){
                              $q3 = $this->db->query("select * from db_booking_orderpayments where order_id=$purchase_id");
                              if($q3->num_rows()>0){
                                $i=1;
                                $total_paid = 0;
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a href="<?php echo $base_url; ?>orders/update/<?php echo  $purchase_id ?>" class="btn btn-success">
          ...
          <a href="<?php echo $base_url; ?>orders/print_invoice/<?php echo  $purchase_id ?>" target="_blank" class="btn btn-warning">
              <i class="fa fa-print"></i> 
            Print
          </a>


          <a href="<?php echo $base_url; ?>orders/pdf/<?php echo  $purchase_id ?>" target="_blank" class="btn btn-primary">
