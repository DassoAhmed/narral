...
<div class="wrapper">
  ...
  <?php 
      ...
      $booked_birds_total=$this->db->query("SELECT COALESCE(SUM(qty_taken),0) AS booked_items FROM db_booking")->row()->booked_items;
       //total sales due
      $sales_due_total=$this->db->query("SELECT COALESCE(SUM(booking_due),0) AS booking_due FROM db_customers")->row()->booking_due;
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
             ...
             <p>Total <?= $this->lang->line('qty_taken'); ?></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box" style="background:#8700ff87;color:#fff">
            <div class="inner">
              <h3><?= $CI->currency($sales_due_total,$with_comma=true);?></h3>
              <p><?= $this->lang->line('total_booking_due'); ?></p>
            </div>
            <div class="icon">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="booking_list2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('qty_taken'); ?></th>
                  <th><?= $this->lang->line('qty_left'); ?></th>
                  <!-- <th>Warehouse</th> -->
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('booking/full_ajax_list')?>",
            "type": "POST",
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 6 ).footer() ).html(app_number_format(qty_taken));
            $( api.column( 7 ).footer() ).html(app_number_format(qty_left));
