            ...
            <form class="form-horizontal" id="state-form" method="post">
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
				  ...
				  <label for="state" class="col-sm-3 control-label"><?= $this->lang->line('state_name'); ?><label class="text-danger">*</label></label>
                  <div class="col-sm-6">
				...
				<div class="form-group">
				 <label for="country_name" class="col-sm-3 control-label"><?= $this->lang->line('country'); ?><label class="text-danger">*</label></label>
              ...
              <!-- /.box-body -->
                ...
                <div class="col-sm-8 col-sm-offset-2 text-center">
                   ...
                   <div class="col-md-3 col-md-offset-3">
                      <button type="button" style="padding: 12px 12px;font-size: 17px;color:#fff;"id="<?php echo $btn_id;?>" class=" btn btn-block btn-success" title="Save Data"><?php echo $btn_name;?></button>
                   </div>
                   <div class="col-sm-3">
                    <a href="<?=base_url('dashboard');?>">
                      <button type="button"style="padding: 12px 12px;font-size: 17px;background:red;color:#fff;" class="col-sm-3 btn btn-block btn-warning close_btn" title="Go Dashboard">Close</button>
                    </a>
                   </div>
                </div>
             </div>
