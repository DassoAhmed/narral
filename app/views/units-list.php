 ...
 ?>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      <div class="row">
      <?php include"modals/modal_units.php"; ?>
        <!-- ********** ALERT MESSAGE START******* -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-block btn-success" data-toggle="modal" data-target="#units_modal" title="New Unit?">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('short_name'); ?></th>
                  <th><?= $this->lang->line('base_unit'); ?></th>
                  <th><?= $this->lang->line('operator'); ?></th>
                  <th><?= $this->lang->line('operator_value'); ?></th>
