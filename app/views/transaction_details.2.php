      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="transaction_datatable" class="table table-bordered table-striped" width="100%">
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 1 ).footer() ).html(app_number_format(purchase_due));
            $( api.column( 2 ).footer() ).html(app_number_format(purchase_return_due));
        },
        /*End Footer Total*/
    });
