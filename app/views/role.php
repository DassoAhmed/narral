                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('manufacturing'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="manufacturing" > <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[manufacturing]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="manufacturing_all" id='manufacturing_add' name="permission[manufacturing_add]" > <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="manufacturing_all" id='manufacturing_edit' name="permission[manufacturing_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="manufacturing_all" id='delete_job' name="permission[delete_job]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="manufacturing_all" id='manufacturing_view' name="permission[manufacturing_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="manufacturing_all" id='job_add' name="permission[job_add]"> <?= $this->lang->line('job_add'); ?>
                                              </label></div>
                                        ...
                                        <tr>
                                          <td><?= $i++;?></td>
                                          <td><?= $this->lang->line('booking'); ?></td>
                                          <td>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="change_me" id="booking" > <?= $this->lang->line('select_all'); ?>
                                              </label></div>
                                          </td>
                                          <td>
                                              <input type="hidden" name="module[booking]" value="on">
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_add' name="permission[booking_add]" > <?= $this->lang->line('add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_edit' name="permission[booking_edit]"> <?= $this->lang->line('edit'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_delete' name="permission[booking_delete]"> <?= $this->lang->line('delete'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_view' name="permission[booking_view]"> <?= $this->lang->line('view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_payment_add' name="permission[booking_payment_add]"> <?= $this->lang->line('booking_payment_add'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_payment_view' name="permission[booking_payment_view]"> <?= $this->lang->line('booking_payment_view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='order_view' name="permission[order_view]"> <?= $this->lang->line('order_view'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="booking_all" id='booking_place_order' name="permission[booking_place_order]"> <?= $this->lang->line('booking_place_order'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                        <!-- SMS -->
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                              ...
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='booking_items_report' name="permission[booking_items_report]"> <?= $this->lang->line('booking_report'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='booking_payments_report' name="permission[booking_payments_report]"> <?= $this->lang->line('booking_payments_report'); ?>
                                              </label></div>
                                              <div class="checkbox icheck"><label>
                                                <input type="checkbox" class="reports_all" id='daily_report' name="permission[daily_report]"> <?= $this->lang->line('daily_report'); ?>
                                              </label></div>
                                          </td>
                                        </tr>
                                      </tbody>
