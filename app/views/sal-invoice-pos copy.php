...
<link rel="stylesheet" href="<?php echo $theme_link; ?>all/style.css">
		...
		<tr>
			<td>
				<table style="margin-left:90px">
					<!-- <tr>
						<td style="margin-left:-200px" ><b>#<?= $sales_code; ?></b></td>
					</tr> -->
					<tr>
						<td style="margin-left:-80px;">Customer: <?= $customer_name; ?></td>
						<td ></td>
					</tr>
					<tr>
					<td style="margin-left:-80px;font-weight:bold"><?= $this->lang->line('date').":".$sales_date; ?></td>
					</tr>
				</table>
				...
				<table align="center" cellpadding="0" cellspacing="0"  >
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              $subtotal=0;
			              $tax_amt=0;
			              $q2=$this->db->query("SELECT b.item_name,a.sales_qty,a.unit_total_cost,a.price_per_unit,a.tax_amt,c.tax,a.total_cost,a.bag_qty,a.kg_qty from db_salesitems a,db_items b,db_tax c where c.id=a.tax_id and b.id=a.item_id and a.sales_id='$sales_id'");
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'> <span>".$res2->bag_qty."<br>".$res2->bag_qty."</span>".$res2->sales_qty." kg(s)  X  ".number_format(($res2->unit_total_cost),2,'.','')."
							  
							  </td>";
			                //   echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;'>".number_format(($res2->unit_total_cost),2,'.','')."</td>";
			                  echo "<td style='text-align: right;padding-left: 1px; padding-right: 3px;' > " ." = ".number_format(($res2->total_cost),2,'.','')."</td>";
			                  echo "</tr>";  
					...
					<tfoot >
					 ...
					 <tr >
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" colspan="4" align="left"><?= $this->lang->line('before_tax'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format(($before_tax),2,'.','');?></td>
					</tr>
					<tr >
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" colspan="4" align="left"><?= $this->lang->line('tax_amount'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format(($tax_amt),2,'.','');?></td>
					</tr>
					<!-- <tr >
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight:bold" colspan="4" align="left"><?= $this->lang->line('discount'); ?> <?= ($discount_to_all_type=='in_percentage') ? $discount_to_all_input .'%' : $discount_to_all_input.'[Fixed]' ;?></td>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format(($tot_discount_to_all_amt),2,'.',''); ?></td>
					</tr>
					<?php } ?>
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" colspan="4" align="left"><?= $this->lang->line('total'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= $grand_total; ?></td>
					</tr>
					...
					<?php if(change_return_status()) {
						...
						<tr>
							<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" colspan="4" align="left"><?= $this->lang->line('paid_amount'); ?></td>
							<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format($paid_amount+$change_return_amount,2,'.',''); ?></td>
						</tr>
						<tr>
							<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" colspan="4" align="left"><?= $this->lang->line('refund'); ?></td>
							<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format($change_return_amount,2,'.',''); ?></td>
						</tr>
					<?php }
					else{ ?>
						<tr>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight:bold" colspan="4" align="left"><?= $this->lang->line('paid_amount'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px; font-weight:bold" align="left"><?= number_format($paid_amount,2,'.',''); ?></td>
					</tr>
					
					<?php } ?>
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight:bold" colspan="4" align="left"><?= $this->lang->line('due_amount'); ?></td>
						<td style=" padding-left: 2px; padding-right: 2px;font-weight:bold" align="left"><?= number_format($grand_total-$paid_amount,2,'.',''); ?></td>
					</tr>
