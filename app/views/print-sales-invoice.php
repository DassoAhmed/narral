...
<table align="center" width="50%" height='100%'>
    <thead>
      ...
      <tr>
          <th colspan="2" rowspan="2" style="padding-left: 15px;">
          ...
          <th colspan="2" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('sales_invoice'); ?> </b>(<?=$sales_status;?>)</th>
      ...
      <tr>
          ...
          <th colspan="1" rowspan="1"><?= $this->lang->line('date'); ?> : <?php echo show_date($sales_date)." ".$created_time; ?></th>
      </tr>
  ...
  <tr>
    ...
    <!-- <th rowspan='2'><?php // $this->lang->line('sales_price'); ?></th> -->
...
<tfoot>
  ...
  <tr>
    <td colspan="4" style="text-align: right;"><b><?= $this->lang->line('discount_on_all'); ?>(<?= $discount_to_all_input." ".$discount_to_all_type; ?>)</b></td>
...
<?php
  ...
  <tr>
    <td colspan="3" style="height:50px;">
      <b><?= $this->lang->line('customer_signature'); ?></b><br/>&nbsp;<br/>
    </td>
    <td colspan="2">
      <b><?= $this->lang->line('authorised_signature'); ?></b><br/><br/>
    </td>
  </tr>
