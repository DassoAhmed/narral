  ...
  <!-- </copy> -->  
   ...
   <body class="hold-transition skin-blue  sidebar-mini">
      ...
      <?php
         if(!isset($item_name)){
         $custom_barcode ='';
         $item_name=$sku=$opening_stock=$sales_unit = $sales_unit_id = $item_code=$brand_id=$category_id=$gst_percentage=$tax_type=
      ...
      <div class="content-wrapper">
         ...
         <section class="content">
            <div class="row">
               ...
               <?php include"modals/brands_modal.php"; ?>
                        ...
                        <div class="box-body">
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <span class="input-group-addon pointer" data-toggle="modal" data-target="#brands-modal" title="New Customer?"><i class="fa fa-plus text-primary fa-lg"></i></span>
                                    </div>
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <span class="input-group-addon pointer" data-toggle="modal" data-target="#categories-modal" title="New Customer?"><i class="fa fa-plus text-primary fa-lg"></i></span>
                                    </div>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="unit_id" class="control-label"><?= $this->lang->line('sales_unit'); ?><span class="text-danger">*</span></label>
                                 
                                 <select class="form-control select2" id="sales_unit" name="sales_unit"  style="width: 100%;"  value="<?php print $sales_unit; ?>" >
                                    <?php
                                       $query1="select * from db_units where status=1";
                                       $q1=$this->db->query($query1);
                                       if($q1->num_rows($q1)>0)
                                        {
                                         echo '<option value="">-Select-</option>'; 
                                            foreach($q1->result() as $res1)
                                          {
                                            $selected = ($res1->id==$sales_unit_id)? 'selected' : '';
                                            echo "<option $selected value='".$res1->id."'>".$res1->unit_name."</option>";
                                          }
                                        }
                                        else  
