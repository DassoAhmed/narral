...
style="background: url('<?= base_url('uploads/bg/8.jpg') ?>') no-repeat center center fixed">
  <?php 
  //Find Logo Path
    $logo=$this->db->query("select logo from db_sitesettings")->row()->logo;
  ?>
<div class="login-box" style="border: 8px solid #038762;border-radius: 10px;box-shadow: 0px 4px 2px 4px #c9c9cd;">
  <div class="login-logo">
    <a href="#"><b>
      <img src="<?php echo $base_url; ?>uploads/<?= $logo;?>" style="vertical-align: middle;border-radius: 100px;height: 202px;padding: 15px;">
    </b></a>
  </div>
  <!-- /.login-logo -->
