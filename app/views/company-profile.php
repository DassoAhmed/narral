      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span id="upi_id_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                     <div class="col-sm-8 col-sm-offset-4">
                        <img class='img-responsive' style='border:3px solid #d2d6de;border-radius: 49%;height: 322px;' src="<?= $upi_code;?>">
                     </div>
                  </div>
                  <!-- ########### -->
               </div>
          ...
          <span id="address_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                     <div class="col-sm-8 col-sm-offset-4">
                        <img class='img-responsive' style='border:3px solid #d2d6de;border-radius: 49%;height: 322px;' src="<?php echo $base_url; ?>uploads/company/<?= $company_logo;?>">
                     </div>
                  </div>
