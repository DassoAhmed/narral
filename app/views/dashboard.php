...
<style type="text/css">
   ...
   .bg-pur{
    background-color: #3106a8 !important;
    color:#fff;
    border-radius: 50px;
   }
   .bg-pink{
  ...
  <div class="content-wrapper ">
    ...
    <section class="content">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-pur"><i class="ion ion-bag"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_purchase'); ?></span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($total_purchase)); ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-pur"><i class="ion ion-bag"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_booking_order'); ?></span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($total_order)); ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-aqua"><i class="ion ion-bag"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_order_due'); ?></span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($order_due)); ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-cart-plus"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_booking_amount'); ?></span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($tot_bking_grand_total)); ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-yellow"><i class="fa fa-money"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_booking_due'); ?></span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($booking_due)); ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
       ...
       <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('net_profit'); ?></span>
                   <span class="info-box-number"><?= $net_profit; ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-pink"><i class="fa fa-pie-chart"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_booked_item_count'); ?></span>
                   <span class="info-box-number"><?= $qty_booked; ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                <span class="info-box-icon bg-pink"><i class="fa fa-list"></i></span>
                <div class="info-box-content">
                   <span class="text-bold text-uppercase"><?= $this->lang->line('total_item_count'); ?></span>
                   <span class="info-box-number"><?= $tot_items; ?></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
     ...
     <div class="col-md-8">
     	<!-- BAR CHART -->
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="barChart" style="height:230px; color:#fff;"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
     ...
     <div class="col-md-5">
      ...
      <?php 
        ...
        $jan_ord=$feb_ord=$mar_ord=$apr_ord=$may_ord=$jun_ord=$jul_ord=$aug_ord=$sep_ord=$oct_ord=$nov_ord=$dec_ord=0;
        $jan_sal=$feb_sal=$mar_sal=$apr_sal=$may_sal=$jun_sal=$jul_sal=$aug_sal=$sep_sal=$oct_sal=$nov_sal=$dec_sal=0;
        $jan_book=$feb_book=$mar_book=$apr_book=$may_book=$jun_book=$jul_book=$aug_book=$sep_book=$oct_book=$nov_book=$dec_book=0;

        $q3=$this->db->query("SELECT COALESCE(SUM(grand_total),0) AS ord_total,MONTH(order_date) AS order_date FROM db_booking_orders where order_status='Received'  GROUP BY MONTH(order_date) ");
        if($q3->num_rows() >0){
          foreach($q3->result() as $res2){
            if($res2->order_date == '1'){ $jan_pur = $res2->ord_total; }
            else if($res2->order_date == '2'){ $feb_ord = $res2->ord_total; }
            else if($res2->order_date == '3'){ $mar_ord = $res2->ord_total; }
            else if($res2->order_date == '4'){ $apr_ord = $res2->ord_total; }
            else if($res2->order_date == '5'){ $may_ord = $res2->ord_total; }
            else if($res2->order_date == '6'){ $jun_ord = $res2->ord_total; }
            else if($res2->order_date == '7'){ $jul_ord = $res2->ord_total; }
            else if($res2->order_date == '8'){ $aug_ord = $res2->ord_total; }
            else if($res2->order_date == '9'){ $sep_ord = $res2->ord_total; }
            else if($res2->order_date == '10'){ $oct_ord = $res2->ord_total; }
            else if($res2->order_date == '11'){ $nov_ord = $res2->ord_total; }
            else if($res2->order_date == '12'){ $dec_ord = $res2->ord_total; }
          }
        }
        ...
        //DONUS CHART
        $q4=$this->db->query("SELECT COALESCE(SUM(grand_total),0) AS booking_total,MONTH(booked_date) AS booking_date FROM db_booking where booking_status='Final' GROUP BY MONTH(booked_date)");
        if($q4->num_rows() >0){
          foreach($q4->result() as $res4){
            if($res4->booking_date == '1'){ $jan_sal = $res4->sal_total; }
            else if($res4->booking_date == '2'){ $feb_book = $res4->booking_total; }
            else if($res4->booking_date == '3'){ $mar_book = $res4->booking_total; }
            else if($res4->booking_date == '4'){ $apr_book = $res4->booking_total; }
            else if($res4->booking_date == '5'){ $may_book = $res4->booking_total; }
            else if($res4->booking_date == '6'){ $jun_book = $res4->booking_total; }
            else if($res4->booking_date == '7'){ $jul_book = $res4->booking_total; }
            else if($res4->booking_date == '8'){ $aug_book = $res4->booking_total; }
            else if($res4->booking_date == '9'){ $sep_book = $res4->booking_total; }
            else if($res4->booking_date == '10'){ $oct_book = $res4->booking_total; }
            else if($res4->booking_date == '11'){ $nov_book = $res4->booking_total; }
            else if($res4->booking_date == '12'){ $dec_book = $res4->booking_total; }
          }
        }
  ...
  $(function () {
    ...
    var barChartData = {
      ...
      datasets: [
        ...
        {
          label: "Booking Purchase Amt(in <?= $CI->currency();?>)",
          fillColor: "#9d05f2",
          strokeColor: "#9d05f2",
          pointColor: "rgba(210, 214, 222, 1)",
          pointStrokeColor: "#c1c7d1",
          pointHighlightFill: "#fff",
          pointHighlightStroke: "rgba(220,220,220,1)",
          data: [<?php echo $jan_ord; ?>, <?php echo $feb_ord; ?>, <?php echo $mar_ord; ?>, <?php echo $apr_ord; ?>, <?php echo $may_ord; ?>, <?php echo $jun_ord; ?>, <?php echo $jul_ord; ?>, <?php echo $aug_ord; ?>, <?php echo $sep_ord; ?>, <?php echo $oct_ord; ?>, <?php echo $nov_ord; ?>, <?php echo $dec_ord; ?>]
        },
        {
          label: "Booking Amt(in <?= $CI->currency();?>)",
          fillColor: "#0800ff",
          strokeColor: "#0800ff",
          pointColor: "#3b8bba",
          pointStrokeColor: "rgba(60,141,188,1)",
          pointHighlightFill: "#fff",
          pointHighlightStroke: "rgba(60,141,188,1)",
          data: [<?php echo $jan_book; ?>, <?php echo $feb_book; ?>, <?php echo $mar_book; ?>, <?php echo $apr_book; ?>, <?php echo $may_book; ?>, <?php echo $jun_book; ?>, <?php echo $jul_book; ?>, <?php echo $aug_book; ?>, <?php echo $sep_book; ?>, <?php echo $oct_book; ?>, <?php echo $nov_book; ?>, <?php echo $dec_book; ?>]
        }
      ]
    };
