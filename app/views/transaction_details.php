...
<div class="row">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a href="<?php echo $base_url; ?>booking/pdf/<?php echo  $delivered_date ?>" target="_blank" class="btn btn-info">
              <i class="fa fa-file-pdf-o"></i> 
            PDF
          </a>
          <a href="<?php echo $base_url; ?>booking/pdf/<?php echo  $delivered_date ?>" target="_blank" class="btn btn-success">
