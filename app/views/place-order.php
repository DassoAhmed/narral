...
<div class="wrapper"> 
 ...
 <?php
    if(!isset($purchase_id)){
      $supplier_id  = $pur_date =  $order_qty = $purchase_status = $warehouse_id =
      $reference_no  =
      $other_charges_input = $delivery_date = $other_charges_tax_id = $total_briolers=$total_eggs=$total_layers=
      $discount_input = $discount_type  = $purchase_note='';
      $pur_date=show_date(date("d-m-Y"));
    }
    else{
      $q2 = $this->db->query("select * from db_booking_orders where id=$purchase_id");
      ...
      $items_count = $this->db->query("select count(*) as items_count from db_booking_orderitems where order_id=$purchase_id")->row()->items_count;
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         <h1>
            <?=$page_title;?>
            <small>Add/Place Booking Order</small>
         </h1>
         <ol class="breadcrumb">
            <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo $base_url; ?>purchase"><?= $this->lang->line('purchase_list'); ?></a></li>
            <li><a href="<?php echo $base_url; ?>booking/add"><?= $this->lang->line('place_order'); ?></a></li>
                     ...
                     <div class="box box-info " >
                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              ...
                              <div class="col-sm-2">
                                 <label for="supplier_id" class="control-label"><?= $this->lang->line('supplier_name'); ?><label class="text-danger">*</label></label>
                                 ...
                                 <div class="col-sm-2">
                                 <label for="pur_date" class="control-label"><?= $this->lang->line('order_date'); ?> <label class="text-danger">*</label></label>
                                    ...
                                    <span id="pur_date_msg" style="display:none" class="text-danger"></span>
                                             ...
                                             <!-- delivery date -->
                                             <div class="col-sm-3">
                                 <label for="pur_date" class="control-label"><?= $this->lang->line('delivery_date'); ?> <label class="text-danger">*</label></label>
                                
                                    <div class="input-group date">
                                       <div class="input-group-addon">
                                          <i class="fa fa-calendar"></i>
                                       </div>
                                       <input type="text" class="form-control pull-right datepicker"  id="delivery_date" name="delivery_date" readonly onkeyup="shift_cursor(event,'purchase_status')" value="<?= $delivery_date;?>">
                                    </div>
                              ...
                              <div class="col-sm-3">
                                 <label for="purchase_status" class="control-label"><?= $this->lang->line('status'); ?> <label class="text-danger">*</label></label>
                                 ...
                                 <div class="col-sm-2">
                                  <label for="reference_no" class="control-label"><?= $this->lang->line('reference_no'); ?> </label>
                                            ...
                                            <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                              <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="Item name/New Order" id="item_search">
                                              </div>
                                            </div>
                                            <br>
                                            <br>
                                          ...
                                          <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:5%"><?= $this->lang->line('order_price'); ?>(<?=$CURRENCY;?>)</th>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-6">
                                          <label for="" class=" control-label"><?= $this->lang->line('total_briolers'); ?></label>    
                                              ...
                                              ?>
                                               ...
                                               <input type="hidden" name="total_briolers" id="order_qty" class="form-control order_qty" placeholder="enter total quantity of Briolers to order">   
                                          </div>
                                          <div class="col-sm-6">
                                          
                                               <input type="hidden" name="total_layers" id="order_qty" placeholder="enter total quantity of Layers to order" class="form-control order_qty">
                                          </div>
                                          <div class="col-sm-6">
                                            <input type="hidden" name="total_eggs" id="order_qty" placeholder="enter total number of trays" class="form-control order_qty">
                                           </div>
                                          </div>
...
<!-- ./wrapper -->
<script src="<?php echo $theme_link; ?>js/booking_order.js"></script>  
<script>
           ...
           for(i=1;i<=rowcount;i++){
             ...
             if(document.getElementById("td_data_"+i+"_3")){
               ...
               if($("#td_data_"+i+"_3").val()!=null && $("#td_data_"+i+"_3").val()!=''){
                    ...
                    order_qty +=parseFloat($("#td_data_"+i+"_3").val().trim());
                }
