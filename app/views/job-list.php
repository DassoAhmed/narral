...
if(!isset($job_name)){
$job_name=$reference_no=$description='';
}
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= $this->lang->line('manufacturing_list'); ?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header ">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>manufacturing/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_job'); ?></a>
...
<script src="<?php echo $theme_link; ?>js/jobs-list.js"></script>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('manufacturing/ajax_job_list')?>",
            "type": "POST",
