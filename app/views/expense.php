...
<div class="wrapper">
 ...
 <?php include"sidebar.php"; ?>
  ...
  <?php
    ...
    $category_id =$expense_for=$note=$expense_amt=$payment_type=$q_id=$reference_no='';
          ...
          <span id="expense_amt_msg" style="display:none" class="text-danger"></span>
               ...
               <div class="col-md-5">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                      <select class="form-control select2" id='payment_type' name="payment_type" onkeyup="shift_cursor(event,'payment_type')" value="<?php print $payment_type; ?>">
                        <?php
                          $q1=$this->db->query("select * from db_paymenttypes where status=1");
                            if($q1->num_rows()>0){
                              echo "<option value=''>-Select-</option>";
                                foreach($q1->result() as $res1){
                                  $selected = ($payment_type==$res1->id)? 'selected' : '';
             ...
             <div class="box-footer">
                <div class="col-sm-8 col-sm-offset-2 text-center">
                   ...
                   <div class="col-md-3 col-md-offset-3">
                      <button type="button" style="padding:15px;width:120px" id="<?php echo $btn_id;?>" class=" btn btn-block btn-success" title="Save Data"><?php echo $btn_name;?></button>
                   </div>
                   <div class="col-sm-3">
                    <a href="<?=base_url('dashboard');?>">
                      <button type="button" style="padding:15px; background:red;width:120px"  class="col-sm-3 btn btn-block btn-warning close_btn" title="Go Dashboard">Close</button>
                    </a>
                   </div>
                </div>
             </div>
