			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr style="border-top-style: dashed;border-bottom-style: dashed;border-width: 0.1px;">
						...
						<th style="font-size: 11px; text-align: left;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('item_name'); ?></th>
						<th style="font-size: 11px; text-align: center;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('quantity'); ?></th>
						<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('unit_price'); ?></th>
					...
					<tfoot>
					 ...
					 <tr >
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="4" align="right"><?= $this->lang->line('sub_total'); ?></td>
