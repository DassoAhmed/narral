            ...
            <form class="form-horizontal" id="tax-form" >
              ...
              <div class="box-body">
				      ...
				      <div class="form-group">
      				  <label for="tax_name" class="col-sm-3 control-label"><?= $this->lang->line('tax_name'); ?><label class="text-danger">*</label></label>
                <div class="col-sm-6">
                 <input type="text" class="form-control input-sm " id="tax_name" name="tax_name" placeholder="" value="<?php print $tax_name; ?>" autofocus onkeyup="shift_cursor(event,'tax')" >
			        ...
			        <div class="form-group">
                <label for="tax" class="col-sm-3 control-label"><?= $this->lang->line('tax_percentage'); ?><label class="text-danger">*</label></label>
                <div class="col-sm-6">
