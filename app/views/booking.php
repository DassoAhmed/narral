 ...
 <?php      
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         <h1>
            <?=$page_title;?>
            <small>Add/Update Booking</small>
         </h1>
         <ol class="breadcrumb">
            <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo $base_url; ?>booking"><?= $this->lang->line('booking_list'); ?></a></li>
            <li><a href="<?php echo $base_url; ?>booking/add">New Booking</a></li>
               ...
               <!-- ********** ALERT MESSAGE END******* -->
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="box box-info " >
                        ...
                        <!-- form start -->
                         <!-- OK START -->
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'booking-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              ...
                              <div class="col-sm-3">
                                 <label for="customer_id" class=" control-label"><?= $this->lang->line('customer_name'); ?><label class="text-danger">*</label></label>
                              ...
                              <div class="col-sm-3">
                                 <label for="booking_status" class=" control-label"><?= $this->lang->line('status'); ?> <label class="text-danger">*</label></label>
                                 
                                       <select class="form-control select2" id="booking_status" name="booking_status"  style="width: 100%;" onkeyup="shift_cursor(event,'mobile')">
                                          <?php 
                                               $received_select = ($booking_status=='Final') ? 'selected' : ''; 
                                               $pending_select = ($booking_status=='Quotation') ? 'selected' : '';
                                          ?>
                           ...
                           <div class="row">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="box box-info">
                                       ...
                                       <div class="box-body ">
                                          ...
                                          <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                              <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="Enter Bird name" id="item_search">
                                              </div>
                                            </div>
                                          ...
                                          <table class="table table-hover table-bordered" style="width:100%" id="booking_table">
                              ...
                              <div class="row">
                                    <div class="col-md-12">
                                    <div class="form-group text-aqua">
                                           
                                            <label for="net_total_booked" class="col-sm-4 control-label"><?= $this->lang->line('net_total_booked'); ?> :</label> 
                                            <div class="col-sm-4" style="border:1px solid white;">
                                            <label class="control-label total_quantity text-white" style="font-size: 15pt;">0</label>
                                             </div>
                                            </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-12">
                                       ...
                                       <div class="col-sm-4">   </div>
                                          ...
                                          <div class="col-sm-4">
                                          <label for="qty_booked" class="control-label"><?= $this->lang->line('chicks_booked'); ?></label>    

                                             <input type="text" class="form-control qty_booked  text-right only_currency" readonly id="qty_booked" name="qty_booked" onkeyup="final_total();" value="<?php echo $qty_booked; ?>">
                                          </div>
                                          ...
                                          <div class="box box-solid bg-gray">
                                            ...
                                            <hr /> 
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                  <div class="">
                                                  <label for="amount"><?= $this->lang->line('t_amount_paid'); ?></label>
                                                    <input type="text" class="form-control text-right paid_amt only_currency" id="amount" name="amount" placeholder="0.00" >
                              ...
                              <center>
                                ...
                                ?>
                                 <div class="col-md-3 col-md-offset-3">
                                    <button type="button" id="<?php echo $btn_id;?>" class="btn bg-orange btn-block btn-flat btn-lg payments_modal make_sale" title="Save Data"><?php echo $btn_name;?></button>
                                 </div>
