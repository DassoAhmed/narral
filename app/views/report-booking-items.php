            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-bordered table-hover " id="report-data" >
                ...
                <tr>
                  ...
                  <th style=""><?= $this->lang->line('amount_paid'); ?>(<?= $CI->currency(); ?>)</th>
                  <th style=""><?= $this->lang->line('due'); ?>(<?= $CI->currency(); ?>)</th>
                </tr>
                </thead>
                <tbody id="tbodyid">
...
<script src="<?php echo $theme_link; ?>js/report-booking-item.js"></script>
<script src="<?php echo $theme_link; ?>js/report-booking-cash-payment.js"></script>
