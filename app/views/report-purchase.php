  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
          <div class="box box-info " style="box-shadow: -3px 2px 20px 2px black;">
            <div class="box-header with-border">
              <h3 class="box-title">Select Date for range to search or filter by Supllier Name</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
						...
						if($q1->num_rows()>0)
             {
                 foreach($q1->result() as $res1)
				  ...
				  <label for="supplier_id" class="col-sm-2 control-label"><?= $this->lang->line('chart_of_account'); ?></label>
                  <div class="col-sm-3">
				  <select class="form-control select2 " id="supplier_id" name="supplier_id"  style="width: 100%;" onkeyup="shift_cursor(event,'category_name')">
				  <option value="">-All-</option>
					  <?php
                ...
                <div class="col-sm-8 col-sm-offset-2 text-center">
                   ...
                   <div class="col-sm-3">
                    <a href="<?=base_url('dashboard');?>">
                      <button type="button" class="col-sm-3 btn btn-block btn-danger close_btn" title="Go Dashboard">Close</button>
                    </a>
                   </div>
                </div>
             </div>
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Purchase Records Table</h3>
              <div class="col-sm-8  pull-right">
                <label for=""class="col-sm-3">Chart of Accounts</label>
                   <div class="col-md-3 ">
                      <button type="button" id="cash" class=" btn btn-block bg-orange" title="Cash Data"><i class="fa fa-money " aria-hidden="true"></i> Cash</button>
                   </div>
                   <div class="col-md-3 ">
                      <button type="button" id="momo" class=" btn btn-block btn-primary" title="Momo"><i class="fa fa-tablet" aria-hidden="true"></i> Momo</button>
                   </div>
                   <div class="col-sm-3">
                      <button type="button" id="bank" class="col-sm-3 btn btn-block bg-purple" title="Bank Data"><i class="fa fa-university" aria-hidden="true"></i> Bank</button>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-bordered table-hove " id="report-data" >
                <thead>
                <tr>
                  <th style="">#</th>
              ...
              <br><br>
              <table class="table table-bordered table-hover " id="report-data" style="background: #00008c;">
                <thead>
                <tr>
                  <th style="">#</th>
                  <th style=""><?= $this->lang->line('invoice_no'); ?></th>
                  ...
                  <th style=""><?= $this->lang->line('payment_type'); ?>(<?= $CI->currency(); ?>)</th>
                </tr>
                </thead>
...
<script src="<?php echo $theme_link; ?>js/report-purchase-momo.js"></script>
<script src="<?php echo $theme_link; ?>js/report-purchase-cash.js"></script>
<script src="<?php echo $theme_link; ?>js/report-purchase-bank.js"></script>
