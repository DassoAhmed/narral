 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
                ...
                //  echo "<td>".$res2->price_per_unit."</td>";
                  ...
                  echo "</tr>";  
                  $tot_qty +=$res2->purchase_qty/$res2->operator_value;
...
<?php
      ...
      {   
       $words = array('0'=> '' ,'1'=> 'One' ,'2'=> 'Two' ,'3' => 'Three','4' => 'Four','5' => 'Five','6' => 'Six','7' => 'Seven','8' => 'Eight','9' => 'Nine','10' => 'Ten','11' => 'Eleven','12' => 'Twelve','13' => 'Thirteen','14' => 'Fouteen','15' => 'Fifteen','16' => 'Sixteen','17' => 'Seventeen','18' => 'Eighteen','19' => 'Nineteen','20' => 'Twenty','30' => 'Thirty','40' => 'Fourty','50' => 'Fifty','60' => 'Sixty','70' => 'Seventy','80' => 'Eighty','90' => 'Ninty','100' => 'Hundred &', '1000'=>'Thousand', '10000'=>'Thousand and','100000' => 'Hundred Thousand and','1000000' => 'Million and');
        if($no == 0)
          return ' ';
        else {
        $novalue='';
      ...
      echo "<span class='amt-in-word'>Amount in words: <i style='font-weight:bold;'>".no_to_words(round($grand_total))." FCFA</i></span>";
