        ...
        <label for="from_date" class="col-sm-2 control-label"><?= $this->lang->line('from_date'); ?></label>
          ...
          <div class="col-sm-3">
            <div class="input-group date">
              ...
              <input type="text" class="form-control pull-right datepicker" id="from_date" name="from_date" value="<?php echo show_date(date('Y-m-d'));?>" readonly>
          ...
          <label for="to_date" class="col-sm-2 control-label"><?= $this->lang->line('to_date'); ?></label>
            ...
            <div class="input-group date">
              ...
              <input type="text" class="form-control pull-right datepicker" id="to_date" name="to_date" value="<?php echo show_date(date('Y-m-d'))?>" readonly>
          ...
          <span id="customer_id_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
          <label for="item_id" class="col-sm-2 control-label"><?= $this->lang->line('payment_type'); ?></label>
   ...
   if(to_date == "")
      {
        ...
        $.post("show_booking_payments_report",{payment_type:payment_type,customer_id:customer_id,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
        ...
        $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
        $.post("booking_customer_payments_report",{payment_type,payment_type,customer_id:customer_id,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
