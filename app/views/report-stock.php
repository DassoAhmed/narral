                  ...
                  <div class="col-md-12">
                     ...
                     <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                           <div class="tab-pane active"style="background: #00402c;color:#fff" id="tab_1">
                              <div class="row">
                                 <!-- right column -->
                                 <div class="col-md-12">
                                    <!-- form start -->
                                       <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>">
                                          ...
                                          <table class="table table-bordered table-hover " id="report-data" >
                                            ...
                                            <tr>
                                              ...
                                              <th style=""><?= $this->lang->line('investment_value'); ?></th>
                           ...
                           <div class="tab-pane"style="background: #00402c;color:#fff" id="tab_2">
                              <div class="row">
                                 <!-- right column -->
                                 <div class="col-md-12">
                                    <!-- form start -->
