 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-sm-7">
            <label for="currency_name" class=" control-label"><?= $this->lang->line('currency_name'); ?><label class="text-danger">*</label></label>
           
             <input type="text" class="form-control input-sm" id="currency_name" name="currency_name" placeholder="eg. FCFA" onkeyup="shift_cursor(event,'currency_name')" value="<?php print $currency_name; ?>" >
      ...
      <div class="col-sm-2"></div>
      <div class="col-sm-7">
            <label for="currency_code" class=" control-label"><?= $this->lang->line('currency_code'); ?></label>
          
             <input type="text" class="form-control input-sm" id="currency_code" name="currency_code" placeholder="eg. XOF " onkeyup="shift_cursor(event,'currency_code')" value="<?php print $currency_code; ?>" >
      ...
      <div class="col-sm-2"></div>
      <div class="col-sm-7">
            <label for="currency" class=" control-label"><?= $this->lang->line('currency_symbol'); ?><label class="text-danger">*</label></label>
          
             <input type="text" class="form-control input-sm" id="currency" name="currency" placeholder="eg.$ " onkeyup="shift_cursor(event,'currency')" value="<?php print $currency; ?>" >
