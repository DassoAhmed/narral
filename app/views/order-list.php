...
<div class="wrapper">
  ...
  <?php 
      /*Total Invoices*/
      $total_invoice=$this->db->query("SELECT COUNT(*) as total FROM db_booking_orders")->row()->total;
      /*Total Invoices Total*/
      $pur_total=$this->db->query("SELECT COALESCE(sum(grand_total),0) AS tot_pur_grand_total FROM db_booking_orders where order_status='Received'")->row()->tot_pur_grand_total;
     //total purchase due
      //$purchase_due_total=$this->db->query("SELECT COALESCE(SUM(purchase_due),0) AS purchase_due FROM db_customers")->row()->purchase_due;
        
      $query9="SELECT (COALESCE(sum(grand_total),0)-COALESCE(sum(paid_amount),0)) as purchase_due FROM db_booking_orders where order_status='Received'";
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="<?= base_url('reports/orders') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('order_code'); ?></th>
