...
*/
    ...
    //  }
     ...
     // }
      ...
      // total discount amt
      $qds=$this->db->query("SELECT COALESCE(SUM(tot_discount_to_all_amt),0) AS tot_discount_to_all_amt FROM db_booking");
        $booking_discount_to_all_amt=$qds->row()->tot_discount_to_all_amt;
      ...
      $qdb=$this->db->query("SELECT COALESCE(SUM(payment),0) AS total_payments FROM db_bookingpayments");
        ...
        // booking order
        $qor=$this->db->query("SELECT COALESCE(SUM(subtotal),0) AS total_order_amt FROM db_booking_orders");
        $total_order_amt=$qor->row()->total_order_amt;
        // other booking charges
      ...
      // booking order due
      $grand_booking_order_total = $total_order_amt + $booking_order_other_charges_amt;
      $order_due = $grand_booking_order_total - $total_booking_order_payments;
      $q1=$this->db->query("
        ...
        <div class="col-md-6">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding" >
                ...
                <tr><td colspan="2" class="text-bold font-italic text-primary"><?= $this->lang->line('booking'); ?></td></tr>
                <!-- Total sales Return -->
                <tr>
                  <td><?= $this->lang->line('grand_total_booking_amt'); ?></td>
                  <td class="text-right text-bold"><?php echo number_format($booking_grand_total,2); ?></td>
                </tr>   
                <!-- Total sales return Tax -->
                <tr>
                  <td><?= $this->lang->line('total_other_charges_on_booking'); ?></td>
                  <td class="text-right text-bold"><?php echo number_format(($booking_other_charges_amt),2); ?></td>
                </tr> 
                
                <!-- Total booking Other Charges -->
                <tr>
                  <td><?= $this->lang->line('booking_discount_to_all_amt'); ?></td>
                  <td class="text-right text-bold"><?php echo number_format($booking_discount_to_all_amt,2); ?></td>
                </tr>
                <!-- Total bookingDoscount -->
                <tr>
                  <td><?= $this->lang->line('total_booking_payments'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo number_format($total_payments,2); ?></td>
                </tr>
                
                <!-- Total booking Paid Amount -->
                <tr>
                  <td><?= $this->lang->line('bookings_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo number_format($booking_due,2); ?></td>
                </tr> 
              <!-- booking order -->
              <tr><td colspan="2" class="text-bold font-italic text-primary"><?= $this->lang->line('booking_order'); ?></td></tr>
              <tr>
                  <td><?= $this->lang->line('total_booking_order'); ?></td>
                  <td class="text-right text-bold "><?php echo number_format($total_order_amt,2); ?></td>
                </tr>
              <tr>
                  <td><?= $this->lang->line('total_booking_order_other_charges'); ?></td>
                  <td class="text-right text-bold "><?php echo number_format($booking_order_other_charges_amt,2); ?></td>
                </tr>
                <!-- Total booking Other Charges -->
                <tr>
                  <td><?= $this->lang->line('booking_order_discount_to_all_amt'); ?></td>
                  <td class="text-right text-bold"><?php echo number_format($booking_order_discount_to_all_amt,2); ?></td>
                </tr>
                <tr>
                  <td><?= $this->lang->line('total_booking_order_payments'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo number_format($total_booking_order_payments,2); ?></td>
                </tr>
                <tr>
                  <td><?= $this->lang->line('order_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo number_format($order_due,2); ?></td>
                </tr>
                <tr>
                  <td><?= $this->lang->line('booking_profit'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo number_format($booking_profit,2); ?></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding" >
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo number_format($net_profit,2); ?></td>
                </tr>   
                </table>
            </div>
            <!-- /.box-body -->
