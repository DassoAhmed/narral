    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <b style="color:magenta;font-size:18px; text-decoration:underline" ><?= $this->lang->line('reference_no'); ?> :<?php echo  $reference_no; ?></b><br>
          ...
          <table class="table table-striped records_table table-bordered">
            ...
            <tbody>
              ...
              $q2=$this->db->query("SELECT a.description, c.item_name, a.sales_qty,
                                  a.price_per_unit, a.delivery_date,
                                  a.unit_discount_per,a.discount_amt, a.unit_total_cost,
                                  a.total_cost ,a.tax_amt, b.tax_name
                                  FROM 
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "</td>";
                  echo"<td>";
                  echo show_date($res2->delivery_date);
                  echo"</td>";
       ...
       <hr style="color:green; border:1px solid green" />
          ...
          <div class="row">
           ...
           <div class="row">
              <div class="col-md-12">
                 <div class="form-group">
                    <table class="table table-hover table-bordered" style="width:100%" id=""><h4 class="box-title text-info"><?= $this->lang->line('payment_tax'); ?> : </h4>
                       <thead>
                          <tr class="bg-green " >
                             <th>#</th>
                       ...
                       <tbody> 
                          <?php 
                                ...
                                foreach ($q2->result() as $res2) {
                                  ...
                                  echo "<tr>";  
                                  echo "<td>".++$i."</td>";
                                  echo "<td class='text-right'>".$tot_tax_amt."</td>";
                                  echo "<td class='text-right'>".$discount."</td>";
                                  echo "<td class='text-right'>".$CI->currency($discount_amt)."</td>";
                                  echo "<td class='text-right'>".$CI->currency(number_format($res2->tax_amt,2,'.',''))."</td>";
                                  echo "</tr>";  
                                  $tot_qty +=$res2->sales_qty;
                                  $tot_sales_price +=$res2->price_per_unit;
                                  // $tot_tax_amt +=$res2->tax_amt;
                          ...
                          <?php 
                            if(isset($sales_id)){
                              ...
                              if($q3->num_rows()>0){
                                ...
                                echo "<tr class='text-right text-bold text-green'><td colspan='4' >Total Paid</td><td>".number_format($total_paid,2,'.','')."</td></tr>";
                                    if($grand_total-$total_paid == 0){
                                    echo "<tr class='text-right text-bold text-red'><td colspan='4' >Payment(s) Complete</td></tr>";
                                  }else{
                                    echo "<tr class='text-right text-bold text-red'><td colspan='4' >Balance</td><td>".number_format($grand_total-$total_paid,2,'.','')."</td></tr>";
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <?php $str2= ($pos==1)? 'pos/edit/':'booking/update/'; ?>
        ...
        <?php } ?>
          ...
          <a href="<?php echo $base_url; ?>booking/print_invoice/<?php echo  $sales_id ?>" target="_blank" class="btn btn-warning">
...
<script>$(".booking-list-active-li").addClass("active");</script>
</body>
</html>
