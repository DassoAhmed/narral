    ...
    public function import_items_csv() {
                ...
                {   
                    ...
                    while(($importdata = fgetcsv($file, NULL, ",")) !== FALSE){
                        ...
                        $sales_unit_id=(!empty($sales_unit_name)) ? $this->get_sales_unit_id($sales_unit_name) : null;
        ...
        public function get_sales_unit_id($sales_unit_name=''){
            $q2=$this->db->query("select id from db_units where upper(unit_name)=upper('$unit_name') ");
            if($q2->num_rows()>0){
                return $q2->row()->id;
            }
