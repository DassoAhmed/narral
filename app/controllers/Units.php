...
class Units extends MY_Controller {
	...
	public function new_balance(){
		$this->form_validation->set_rules('net_balance', 'Net Balance', 'trim|required');

		if ($this->form_validation->run() == TRUE) {
			
			$result=$this->units->verify_and_save_balance();
			echo $result;
		} else {
			echo "Please Enter Balance Amount."; 
		}
	}
