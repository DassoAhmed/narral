...
class Reports extends MY_Controller {
	...
	public function sales_due(){
		$this->permission_check('sales_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('sales_due_report');
		$this->load->view('report-sales-due', $data);
	}
	public function show_sales_due_report(){
		echo $this->reports->show_sales_due_report();
	}
	public function show_sales_report(){
		echo $this->reports->show_sales_report();
	}
	public function show_item_chart_of_acc_sales_report(){
		echo $this->reports->show_item_chart_of_acc_sales_report();
	}
	public function show_item_cash_sales_report(){
		echo $this->reports->show_item_cash_sales_report();
	} 
	public function show_item_bank_sales_report(){
		echo $this->reports->show_item_bank_sales_report();
	}
	public function show_item_momo_purches_report(){
		echo $this->reports->show_item_momo_purches_report();
	}
	public function show_item_cash_purches_report(){
		echo $this->reports->show_item_cash_purches_report();
	}
	public function show_item_bank_purches_report(){
		echo $this->reports->show_item_bank_purches_report();
	}
	...
	public function show_item_momo_expense_report(){
		echo $this->reports->show_item_momo_expense_report();
	}
	...
	public function category_wise_stock(){
		echo $this->reports->category_wise_stock();
	}
	//Item Sales Report 
	...
	public function purchase_due(){
		$this->permission_check('purchase_payments_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('purchase_due_report');
		$this->load->view('report-purchase-due', $data);
	}
	public function show_purchase_due_report(){
		echo $this->reports->show_purchase_due_report();
	}
	...
	public function sales_payment_type_report(){
		echo $this->reports->sales_payment_type_report();
	}
	...
	public function booking_items(){
		$this->permission_check('expired_items_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('booking_items_report');
		$this->load->view('report-booking-items', $data);
	}
	public function booking_customer_due(){
		$this->permission_check('expired_items_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('booking_due_report');
		$this->load->view('report-booking-customer-due', $data);
	}
	public function booking_payments(){
		$this->permission_check('expired_items_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('booking_payments_report');
		$this->load->view('report-booking-payments', $data);
	}
	public function booking_customer_due_report(){
		echo $this->reports->booking_customer_due_report();
	}
	public function booking_report(){
		echo $this->reports->booking_report();
	}
	public function show_item_cash_booking_report(){ 
		echo $this->reports->show_item_cash_booking_report();
	} 
	public function show_booking_payments_report(){ 
		echo $this->reports->show_booking_payments_report();
	} 
	public function booking_customer_payments_report(){ 
		echo $this->reports->booking_customer_payments_report();
	} 
	// receivable_payable
	public function receivable_payable(){
		...
		$data=$this->data;
		$data['page_title']=$this->lang->line('booking_items_report');
		$this->load->view('report-receivable-payable', $data);
	}
	public function account_receivable_report(){ 
		echo $this->reports->account_receivable_report();
	} 
	public function account_payable_report(){ 
		echo $this->reports->account_payable_report();
	} 
	public function accaunt_pay_rec_booking_report(){ 
		echo $this->reports->accaunt_pay_rec_booking_report();
	} 
	public function accaunt_pay_rec_booking_order_report(){ 
		echo $this->reports->accaunt_pay_rec_booking_order_report();
	} 
	// Daily report
	public function daily_report(){
		$this->permission_check('expired_items_report');
		$data=$this->data;
		$data['page_title']=$this->lang->line('daily_report');
